...
def std_plot(rows, cols, dataset, cmax, titles, colours, units, label_loc=None):
...
#     cbar.ax.set_xlabel(f'{units}', fontsize=12, rotation='vertical', va='baseline', ha='left', labelpad=9)
